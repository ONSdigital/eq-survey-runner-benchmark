...
Compared to baseline, there is significant drop in response times in feedback journey, all get and post request perform well so no further investigation is needed.
